...
AppGenerator.prototype.mainStylesheet = function mainStylesheet() {
  this.copy('scss/main.scss', 'app/styles/main.scss');
  this.copy('scss/_base.scss', 'app/styles/_base.scss');
  this.copy('scss/_layout.scss', 'app/styles/_layout.scss');
  this.copy('scss/_modules.scss', 'app/styles/_modules.scss');
  this.copy('scss/_helpers.scss', 'app/styles/_helpers.scss');
  this.copy('scss/yp/_global.scss', 'app/styles/yp/_global.scss');
  this.copy('scss/yp/_grid.scss', 'app/styles/yp/_grid.scss');
};

AppGenerator.prototype.writeIndex = function writeIndex() {

  this.indexFile = this.readFileAsString(
    path.join(this.sourceRoot(), 'html/index.html')
  );
